...
def extract_roi_fft(data4D, pixel_spacing, minradius_mm=15, maxradius_mm=45, kernel_width=5, 
    ...
    roi_center = np.unravel_index(lsurface.argmax(), lsurface.shape) # 返回的索引值从0开始计数
...
if __name__ == '__main__':
  ...
  final_test_dataset = convert_nii_np(final_testing_dataset, mode='tester', roi_detect=True)
