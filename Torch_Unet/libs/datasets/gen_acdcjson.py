...
if __name__ == "__main__":
    ...
    # root_path = "/home/laisong/github/processed_acdc_dataset/hdf5_files"

    # gen_alldatalist(root_path)
    json_file_path = "./acdcjson/ACDCDataList.json"

    generate_train_test_list(json_file_path)
    # gen_every_kind_datalist(kind_path)
    # result_cleanUnet = read_json(json_file_path)
    # print(result_cleanUnet)