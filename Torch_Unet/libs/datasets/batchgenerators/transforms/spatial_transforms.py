...
from libs.datasets.batchgenerators.transforms import RandomCropTransform
from libs.datasets.batchgenerators.transforms.abstract_transforms import AbstractTransform
from libs.datasets.batchgenerators.augmentations.spatial_transformations import augment_spatial, augment_spatial_2, \
...
class SpatialTransform(AbstractTransform):
    ...
    def __call__(self, data_numpy,seg_numpy):
        data = data_numpy
        seg = seg_numpy
...
if __name__=='__main__':
    ...
    data = np.random.rand(1,1,352,352)
    seg = np.random.rand(1,1,352,352)
    data_aug,seg_aug = transform(data,seg)
    print(data_aug.shape,seg_aug.shape)
